...
public class ProdutosEstoque extends javax.swing.JFrame {
    ...
    private DefaultTableModel preencherProdutos(List<Produtos> lista) {
        String[] colunas = {"ID", "Produto", "Valor", "Validade"};
    ...
    private void initComponents() {
        ...
        tblProdutos.setModel(preencherProdutos(ProdutosDAO.listarTodos()));
